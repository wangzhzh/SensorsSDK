...
//初始化极光推送
- (void)setupJPushNotification:(NSDictionary *)launchOptions {
...
#else
    [JPUSHService setupWithOption:launchOptions appKey:JPush_AppKey channel:@"App Store" apsForProduction:YES advertisingIdentifier:nil];
#endif
}
