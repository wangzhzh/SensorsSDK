...
@implementation NSObject (SensorsDataSwizzle)
...
+ (BOOL)sensorsdata_swizzleClassMethod:(SEL)origSel_ withClassMethod:(SEL)altSel_ error:(NSError**)error_ {
    return [GetClass((id)self) sensorsdata_swizzleMethod:origSel_ withMethod:altSel_ error:error_];
}
